...
BEGIN
  ...
  FOR reg IN 
    SELECT np.id as id, np.tipo_destino_id as tipo_destino_id, np.entidad_id as entidad_id, n.asunto as asunto, n.mensaje as mensaje 
    ...
    -- En caso de ser una programacion dirigida a todos los alumnos
    ...
    -- En caso de ser una programacion dirigida a los profesores
