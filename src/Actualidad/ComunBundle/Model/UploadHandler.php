...
namespace Actualidad\ComunBundle\Model;
...
class UploadHandler
{
    ...
    public function trim_accents($string)
    {
     
        $string = trim($string);
     
        $string = str_replace(
            array('Á', 'À', 'Â', 'Ä', 'á', 'à', 'â', 'ä'),
            array('A', 'A', 'A', 'A', 'a', 'a', 'a', 'a'),
            $string
        );
     
        $string = str_replace(
            array('É', 'È', 'Ê', 'Ë', 'é', 'è', 'ê', 'ë'),
        ...
        $string = str_replace(
            array('Ó', 'Ò', 'Ö', 'Ô', 'ó', 'ò', 'ô', 'ö'),
            array('O', 'O', 'O', 'O', 'o', 'o', 'o', 'o'),
            $string
        );
     
        $string = str_replace(
            array('Ú', 'Ù', 'Û', 'Ü', 'ú', 'ù', 'û', 'ü'),
